...
[`tidy()`](https://s7-stats.github.io/statim/reference/tidy.md) takes
the `cld_exec` returned by
[`conclude()`](https://s7-stats.github.io/statim/reference/conclude.md)
...
[`tidy()`](https://s7-stats.github.io/statim/reference/tidy.md) is
...
Use
[`display()`](https://s7-stats.github.io/statim/reference/display.md) to
inspect individual model outputs when there are many:
