...
from [`tidy()`](https://s7-stats.github.io/statim/reference/tidy.md)'s
...
Same two paths as
[`tidy()`](https://s7-stats.github.io/statim/reference/tidy.md)/`glance()`/[`predict()`](https://s7-stats.github.io/statim/reference/predict.md):
